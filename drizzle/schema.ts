import { pgTable, foreignKey, pgEnum, uuid, text, numeric, unique, timestamp, varchar, integer, boolean, index } from "drizzle-orm/pg-core"
...
export const budgets = pgTable("budgets", {
	...
	total: numeric("total", { precision: 12, scale:  2 }),
	averagePricePerM2: numeric("average_price_per_m2", { precision: 12, scale:  2 }),
